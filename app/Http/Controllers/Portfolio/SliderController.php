	...
	public function SliderView(){
     ...
     public function SliderStore(Request $request){
    	...
    	$request->validate([
    		...
    		'slider_img.required' => trans('admin/controllers.select-image'),
...
public function SliderUpdate(Request $request){
    ...
    public function SliderInactive($id){
    	...
    	$notification = array(
			'message' => trans('admin/controllers.slider-inactive-successfully'),
			'alert-type' => 'success'
		);
    ...
    public function SliderActive($id){
    	...
    	$notification = array(
			'message' => trans('admin/controllers.slider-active-successfully'),
			'alert-type' => 'success'
		);

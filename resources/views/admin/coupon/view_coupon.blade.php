...
@section('title')
    {{ trans('admin/sidebar.dashboard') }} | {{ trans('admin/dashboard.coupons') }}
@endsection
@section('admin')
        ...
        <section class="content">
            <div class="row">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ trans('admin/dashboard.coupon-validity') }} </th>
                                                ...
                                                <td>
                                                    @if ($item->coupon_validity >= Carbon\Carbon::now()->format('Y-m-d'))
                                                        <span class="badge badge-pill badge-success">
                                                            {{ trans('admin.valid') }} </span>
                                                    @else
                                                        <span class="badge badge-pill badge-danger">
                                                            {{ trans('admin.invalid') }} </span>
                                                    @endif
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans('admin/dashboard.add-coupon') }} </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('coupon.store') }}">
                                    ...
                                    <div class="form-group">
                                        <h5>{{ trans('admin/dashboard.discount') }} <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5>{{ trans('admin/dashboard.coupon-validity') }} <span class="text-danger">*</span></h5>
                                        <div class="controls">

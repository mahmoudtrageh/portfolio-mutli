...
@section('admin')
			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">{{trans('admin.processing-orders-list')}}</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
 ...
 <a target="_blank" href="{{ route('invoice.download',$item->id) }}" class="btn btn-danger" title="{{trans('admin.invoice-download')}}">

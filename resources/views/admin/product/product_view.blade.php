...
@section('title')
    {{ trans('admin/sidebar.dashboard') }} | {{ trans('admin/sidebar.products') }}
@endsection
@section('admin')
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans('admin/sidebar.products') }} <span
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <a href="{{ route('product.edit', $item->id) }}"
                                                        ...
                                                        title="{{ trans('admin/dashboard.product-details') }}"><i
                                                            class="fa fa-eye"></i> </a>
                                                    ...
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('product.inactive', $item->id) }}"
                                                            class="btn btn-danger" title="{{ trans('admin/dashboard.not-active') }}"><i

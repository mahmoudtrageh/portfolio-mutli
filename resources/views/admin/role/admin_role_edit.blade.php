                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5><b>اختر الدور </b> <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <select name="roles" class="form-control" required="">
                                                            @if ($adminuser->roles->pluck('name')[0] != null)
                                                            <option value="{{$adminuser->roles->pluck('name')[0]}}" selected="" disabled="">
                                                        @else
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>اختيار الصلاحيات <span
                                                            class="text-danger">*</span>
                                                    </h5> 
                                                    @foreach ($permissions as $permission)
                                                    
                                                    <div class="controls">
                                                        <input type="checkbox" name="permissions[]" id="{{$permission->name}}{{$permission->id}}" value="{{$permission->name}}" @if(in_array($permission->id, $rolePermissions)) checked @endif class="form-control">

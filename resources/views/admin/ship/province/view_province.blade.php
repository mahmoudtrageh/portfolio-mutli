...
@section('title')
    {{ trans('admin/sidebar.dashboard') }} | {{ trans('admin/dashboard.provinces') }}
@endsection
@section('admin')
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans('admin/dashboard.provinces') }}</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ trans('admin/dashboard.add-province') }} </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">

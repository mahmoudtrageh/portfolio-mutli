...
@section('home_content')
    ...
    <section id="page-title" style="background-color: #752651;">
        ...
        <div class="container clearfix">
            <h1 class="text-white">صفحة المنتج</h1>
            <ol class="breadcrumb">
                        ...
                        <div class="row gutter-40">
                            ...
                            <div class="col-md-6">
                             ...
                             ============================================= -->
                                ...
                                <button type="submit" data-toggle="tooltip" data-placement="right" title="السلة"
                                    onclick="addToCart()" class="btn btn-primary"><i
                                        class="fa fa-shopping-cart inner-right-vs"></i>{{ trans('site.add-to-cart') }}</button>

                                <a class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="المفضلات"
                             ...
                             ============================================= -->
                                <div class="card product-meta">
                                    <div class="card-body">
                                        <span class="posted_in">القسم : <a href="#"
                                ...
                                <div class="tabs clearfix mb-0" id="tab-1">
                                    ...
                                    <ul class="tab-nav clearfix">
                                        <li><a href="#tabs-1"><i class="icon-align-justify2"></i><span
                                                    class="d-none d-md-inline-block"> الوصف</span></a></li>
                                        <li><a href="#tabs-3"><i class="icon-star3"></i><span
                                                    class="d-none d-md-inline-block"> التقييمات</span></a></li>
                                    </ul>
                                        ...
                                        <div class="tab-content clearfix" id="tabs-3">
                                            ...
                                            <div id="reviews" class="clearfix">
                                                ...
                                                <div class="product-add-review">
                                                    <h4 class="title">{{ trans('site.write-your-own-review') }}
                                                    </h4>
                                                    ...
                                                    <div class="review-form">
                                                        @guest
                                                            <p> <b> {{ trans('site.login-to-add-review') }} <a
                                                                        href="#">{{ trans('site.login') }}</a>
                                                                </b> </p>
                                                        @else
                                                            <div class="form-container">
                                                                ...
                                                                <form role="form" class="cnt-form" method="post"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="exampleInputSummary">{{ trans('site.summary') }}
                                                                                    <span
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="exampleInputReview">{{ trans('site.review') }}
                                                                                    <span
                                                                                        class="astk">*</span></label>
                                                                    ...
                                                                    <div class="action text-right">
                                                                        <button type="submit"
                                                                            class="btn btn-primary btn-upper">{{ trans('site.submit-review') }}</button>
                                                                    </div><!-- /.action -->

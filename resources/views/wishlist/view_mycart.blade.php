...
<section id="page-title" style="background-color: #752651;">
    ...
    <div class="container clearfix">
        <h1 class="text-white">سلة التسوق</h1>
        <ol class="breadcrumb">
								...
								<td>
									<div class="form-group">
										<input type="text" class="form-control unicase-form-control text-input"
											placeholder="{{ trans('site.discount-code') }}.." id="coupon_name">
									</div>
									<div class="clearfix pull-right">
										<button type="submit" class="btn-upper btn btn-primary"
											onclick="applyCoupon()">{{ trans('site.apply-coupon') }}</button>
									</div>
								</td>
							</tr>
						</tbody><!-- /tbody -->
							...
							<td>
								<div class="cart-checkout-btn pull-right">
									<a href="{{route('checkout')}}" type="submit"
										class="btn btn-primary checkout-btn">{{ trans('site.proceed-to-checkout') }}</a>
